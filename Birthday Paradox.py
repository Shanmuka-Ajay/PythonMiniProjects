"""Birthday Paradox Simulation, by Al Sweigart, implemented by Shanmuk Chandu
...
#Display the intro:
print(''' Birthday Paradox, by Al sweigart, implemented by Shanmuk Chandu
...
This program does a Monte Carlo simulation (that is,
repeated random simulations) to explore this concept.
